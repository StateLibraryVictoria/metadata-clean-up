...
data_path = os.path.join(ROOT_DIR, "tests", "test_data", "xml_load_and_process")
...
def test_get_callable_files():
    ...
    expected = [
        os.path.join(input_path, "example_01_korean_rare.xml"),
        os.path.join(input_path, "example_02_chinese_rare.xml"),
        os.path.join(input_path, "example_03_photo_many.xml"),
        os.path.join(input_path, "example_04_photo_many.xml"),
    ]
